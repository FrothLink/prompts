document.addEventListener('DOMContentLoaded', function() {
    ...
    const Fcharacter = ["wizard", "dragon", "shapeshifter", "cook", "peasant", "ruler", "pirate", "merchant", "crafts(wo)man", "storyteller", "magical creature", "aristocrat", "knight", "soldier", "scholar", "spy", "performer", "sailor", "witch", "messenger", "explorer", "bandit"]
    const Splaces = ["on a space station", "in a city", "near a black hole", "on a colony ship", "in a remote area", "in a cafe", "in a library", "in a prison", "in a market", "in an enormous trash heap", "in a strange shop", "on an unexplored planet", "at a spaceport", "in a small town"]
    const Fplaces = ["in a city", "beneath a mountain", "in a forest", "in a dungeon", "far out in the wilderness", "on an ocean", "beneath an ocean", "in a prison", "in a beast's lair", "on a battlefield", "in a strange shop", "in a tavern", "in a castle", "at a port", "in a small town", "journeying in a caravan", "on top of a mountain"]
    //Modifiers
